...
final_json['licenses']["url"] = "http://images.cocodataset.org/val2014/COCO_val2014_000000391895.jpg"
...
for xml_file in os.listdir(xml_file_path):
    if xml_file.endswith('xml'):
        ...
        try:
            ...
            image_info["url"] = "http://images.cocodataset.org/val2014/COCO_val2014_000000391895.jpg"
            ...
            for child1 in groundtree.findall('object'):
                for child2 in child1.findall('cells'):
                    for child3 in child2.findall('tablecell'):
                        ...
                        obj_struct['bbox'] = [int(child3.find('x0').text),int(child3.find('y0').text), int(child3.find('x1').text),int(child3.find('y1').text)]
            ...
            for j in range (len(objects)):
                ...
                if caption == 'tablecell':
                    ...
                    annotation_info["area"]= float((x_max-x_min)*(y_max-y_min))
                    annotation_info["bbox"]= [x_min, y_min, x_max-x_min, y_max-y_min]
